...
// 	}
// 	if !c {
// 		t.Fatalf("file1 should be the same for client1 and client2")
// 	}
...
// 	t.Logf("client1 syncs with file1. majority of the cluster crashes. client2 syncs with file1 (different content). client1 syncs again.")
// 	cfgPath := "./config_files/3nodes.txt"
// 	test := InitTest(cfgPath, "8080")
// 	defer EndTest(test)
...
// 	// majority of the cluster crashes
// 	for i := leaderIdx + 1; i < len(test.Clients); i++ {
